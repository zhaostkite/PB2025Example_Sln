forward
global type w_dwtostr_bak2 from w_center
end type
type cb_help from commandbutton within w_dwtostr_bak2
end type
type cb_createsyntax from commandbutton within w_dwtostr_bak2
end type
type rb_autonvo from radiobutton within w_dwtostr_bak2
end type
type rb_structure from radiobutton within w_dwtostr_bak2
end type
type cb_close from commandbutton within w_dwtostr_bak2
end type
type st_7 from statictext within w_dwtostr_bak2
end type
type st_6 from statictext within w_dwtostr_bak2
end type
type st_5 from statictext within w_dwtostr_bak2
end type
type sle_filename from singlelineedit within w_dwtostr_bak2
end type
type cb_savesyntax from commandbutton within w_dwtostr_bak2
end type
type mle_comment from multilineedit within w_dwtostr_bak2
end type
type dw_datatype from datawindow within w_dwtostr_bak2
end type
type st_4 from statictext within w_dwtostr_bak2
end type
type st_3 from statictext within w_dwtostr_bak2
end type
type ddplb_dw from dropdownpicturelistbox within w_dwtostr_bak2
end type
type st_2 from statictext within w_dwtostr_bak2
end type
type st_1 from statictext within w_dwtostr_bak2
end type
type sle_prefix from singlelineedit within w_dwtostr_bak2
end type
type sle_lib from singlelineedit within w_dwtostr_bak2
end type
type mle_syntax from multilineedit within w_dwtostr_bak2
end type
type cb_openpbl from commandbutton within w_dwtostr_bak2
end type
type gb_1 from groupbox within w_dwtostr_bak2
end type
end forward
...
global w_dwtostr_bak2 w_dwtostr_bak2
...
this.Control[iCurrent+2]=this.cb_createsyntax
this.Control[iCurrent+3]=this.rb_autonvo
this.Control[iCurrent+4]=this.rb_structure
this.Control[iCurrent+5]=this.cb_close
this.Control[iCurrent+6]=this.st_7
this.Control[iCurrent+7]=this.st_6
this.Control[iCurrent+8]=this.st_5
this.Control[iCurrent+9]=this.sle_filename
this.Control[iCurrent+10]=this.cb_savesyntax
this.Control[iCurrent+11]=this.mle_comment
this.Control[iCurrent+12]=this.dw_datatype
this.Control[iCurrent+13]=this.st_4
this.Control[iCurrent+14]=this.st_3
this.Control[iCurrent+15]=this.ddplb_dw
this.Control[iCurrent+16]=this.st_2
this.Control[iCurrent+17]=this.st_1
this.Control[iCurrent+18]=this.sle_prefix
this.Control[iCurrent+19]=this.sle_lib
this.Control[iCurrent+20]=this.mle_syntax
this.Control[iCurrent+21]=this.cb_openpbl
this.Control[iCurrent+22]=this.gb_1
end on

on w_dwtostr_bak2.destroy
call super::destroy
