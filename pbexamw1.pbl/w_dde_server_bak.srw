forward
global type w_dde_server_bak from w_center
end type
type st_6 from statictext within w_dde_server_bak
end type
type cbx_data3 from checkbox within w_dde_server_bak
end type
type cbx_data2 from checkbox within w_dde_server_bak
end type
type cbx_data1 from checkbox within w_dde_server_bak
end type
type sle_data3 from singlelineedit within w_dde_server_bak
end type
type st_4 from statictext within w_dde_server_bak
end type
type mle_msg from multilineedit within w_dde_server_bak
end type
type sle_data2 from singlelineedit within w_dde_server_bak
end type
type sle_data1 from singlelineedit within w_dde_server_bak
end type
type st_2 from statictext within w_dde_server_bak
end type
type st_1 from statictext within w_dde_server_bak
end type
type st_3 from statictext within w_dde_server_bak
end type
type st_5 from statictext within w_dde_server_bak
end type
end forward
...
global w_dde_server_bak w_dde_server_bak
