forward
global type w_dwtostr_bak from w_center
end type
type cb_help from commandbutton within w_dwtostr_bak
end type
type cb_createsyntax from commandbutton within w_dwtostr_bak
end type
type rb_autonvo from radiobutton within w_dwtostr_bak
end type
type rb_structure from radiobutton within w_dwtostr_bak
end type
type cb_close from commandbutton within w_dwtostr_bak
end type
type st_7 from statictext within w_dwtostr_bak
end type
type st_6 from statictext within w_dwtostr_bak
end type
type st_5 from statictext within w_dwtostr_bak
end type
type sle_filename from singlelineedit within w_dwtostr_bak
end type
type cb_savesyntax from commandbutton within w_dwtostr_bak
end type
type mle_comment from multilineedit within w_dwtostr_bak
end type
type dw_datatype from datawindow within w_dwtostr_bak
end type
type st_4 from statictext within w_dwtostr_bak
end type
type st_3 from statictext within w_dwtostr_bak
end type
type ddplb_dw from dropdownpicturelistbox within w_dwtostr_bak
end type
type st_2 from statictext within w_dwtostr_bak
end type
type st_1 from statictext within w_dwtostr_bak
end type
type sle_prefix from singlelineedit within w_dwtostr_bak
end type
type sle_lib from singlelineedit within w_dwtostr_bak
end type
type mle_syntax from multilineedit within w_dwtostr_bak
end type
type cb_openpbl from commandbutton within w_dwtostr_bak
end type
type gb_1 from groupbox within w_dwtostr_bak
end type
end forward
...
global w_dwtostr_bak w_dwtostr_bak
