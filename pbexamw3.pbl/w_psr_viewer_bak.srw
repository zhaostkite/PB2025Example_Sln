forward
global type w_psr_viewer_bak from w_center
end type
type cb_help from commandbutton within w_psr_viewer_bak
end type
type cb_close from commandbutton within w_psr_viewer_bak
end type
type cb_npage from commandbutton within w_psr_viewer_bak
end type
type cb_ppage from commandbutton within w_psr_viewer_bak
end type
type cb_print from commandbutton within w_psr_viewer_bak
end type
type st_file from statictext within w_psr_viewer_bak
end type
type cb_select from commandbutton within w_psr_viewer_bak
end type
type dw_1 from datawindow within w_psr_viewer_bak
end type
end forward
...
global w_psr_viewer_bak w_psr_viewer_bak
